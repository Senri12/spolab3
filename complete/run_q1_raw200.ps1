...
$inputFile = Join-Path $projectRoot "complete\q1_raw200.txt"
$asmOutput = Join-Path $projectRoot "build\task2_v71\q1_raw200.asm"
$parseTreeOutput = Join-Path $projectRoot "build\task2_v71\q1_raw200.dgml"
$binaryFile = Join-Path $projectRoot "build\task2_v71\q1_raw200.ptptb"
$definitionFile = Join-Path $projectRoot "src\TacVm13.target.pdsl"
$devicesFile = Join-Path $projectRoot "complete\q1.raw200.devices.xml"
$resultFile = Join-Path $projectRoot "build\task2_v71\q1.raw200.result.txt"
...
Write-Host "Step 3/3: running raw binary with IO..."
