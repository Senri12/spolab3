...
$inputFile = Join-Path $projectRoot "complete\q2_mini.txt"
$asmOutput = Join-Path $projectRoot "build\task2_v71\q2_mini.asm"
$parseTreeOutput = Join-Path $projectRoot "build\task2_v71\q2_mini.dgml"
$binaryFile = Join-Path $projectRoot "build\task2_v71\q2_mini.ptptb"
$definitionFile = Join-Path $projectRoot "src\TacVm13.target.pdsl"
$devicesFile = Join-Path $projectRoot "complete\q2_mini.devices.xml"
$resultFile = Join-Path $projectRoot "build\task2_v71\q2_mini.result.txt"
...
Write-Host "Step 3/3: running mini binary with IO..."
